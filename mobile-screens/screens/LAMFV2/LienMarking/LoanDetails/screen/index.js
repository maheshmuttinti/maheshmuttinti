...
import {ApplicantAvatar, BackArrow, EditPencil, InfoIcon} from 'assets';
...
import EMIDueDatesModal from '../components/EMIDueDatesModal';
...
export default function ({navigation, route}) {
  ...
  const onSubmit = async () => {
    try {
      navigation.navigate('LAMFV2', {screen: 'LienMarkingSteps'});
      return;
      setLoading(true);
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              Please note that for KYC, you will be required to perform an
              e-sign for which your mobile should be linked with Aadhaar. In
              it’s absence, we will not be able to complete the KYC and Loan
              Process.
            </Text>
          </View>
